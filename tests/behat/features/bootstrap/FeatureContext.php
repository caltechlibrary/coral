...
class FeatureContext extends RawMinkContext {
  ...
  /**
   * @BeforeScenario @reset_management
   */
  public function resetManagementDb(BeforeScenarioScope $scope) {
    $db = new mysqli('db', 'root', 'foobar', 'coral_management');
    ...
    // This SQL file contains an export of the Licensing database in the state
    // immediately following installation; no licenses have been added to it.
    $sql = file_get_contents(__DIR__ . '/coral_management.sql');
    if (!$db->multi_query($sql)) {
      exit('Database reset failed.');
    }
